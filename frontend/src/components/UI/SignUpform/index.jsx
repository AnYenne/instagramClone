          ...
          <div className={styles.wrap}>
              <div>
                  ...
                  <div className={styles.formSignin}>
                    ...
                    <input className={styles.inputSection} type={!showPass ? 'password': 'text'} placeholder='Password'/>
