  ...
  return (
    <div className={styles.container}>
      <div className={styles.topMobile}>
        ...
        {divide == 'mobile' && ( <div className={styles.center}>
            <div className={styles.navItem}>
               <Link to="">
               <Button btn normal stylesCustom={{display: "flex", alignItems:"center", justifyContent:"center"}}>
            <FontAwesomeIcon size="lg" style={{margin: "10px 16px",width: "fit-content"}} icon={faHouse} />
            ...
            <FontAwesomeIcon size="lg" style={{margin: "10px 16px",width: "fit-content"}} icon={faSquarePlus} />
                 ...
                 <div className={styles.navItem} >
                  <Link to="message">
                    ...
                    <Button btn normal stylesCustom={{display: "flex",justifyContent:"flex-start", alignItems:"center"}}>
                        <FontAwesomeIcon size="lg" style={{margin: "10px 16px",width: "fit-content"}} icon={faFacebookMessenger} />
                 <p style={{}}>Messages</p>
                 </Button>
                  </Link>
        ...
        <div className={styles.settingBottom}>
            <div className={clsx(styles.navItem, styles.iconThread)}>
               <Link to="">
               <Button btn normal stylesCustom={{display: "flex", alignItems: 'center', width: '100%', justifyContent: 'flex-start'}}>
            <FontAwesomeIcon size="lg" style={{margin: "10px 16px",width: "fit-content"}} icon={faThreads} />
            ...
            <div className={styles.navItem}>
               <Link to="">
               <Button btn normal stylesCustom={{display: "flex", alignItems: 'center', width: '100%', justifyContent: 'flex-start'}}>
            <FontAwesomeIcon size="lg" style={{margin: "10px 16px",width: "fit-content"}} icon={faBars} />
